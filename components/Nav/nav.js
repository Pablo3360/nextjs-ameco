...
export default function Nav() {
  return (
    <div className={sidebar}>
        ...
        <Link href='/dashboard/affiliates/registerTitular'className={link}>Alta Afiliado</Link>
        <Link href='/dashboard/employers/registerEmpleador'className={link}>Alta Empleador</Link>
